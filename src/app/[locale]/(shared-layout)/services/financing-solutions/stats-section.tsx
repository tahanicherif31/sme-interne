...
const dataStats = [
  { label: "financingPage.totalFin", value: "$70B+" },
  { label: "financingPage.smeFin", value: "15,000+" },
  { label: "financingPage.successRate", value: "94%" },
  { label: "financingPage.countries", value: "54" },
];
